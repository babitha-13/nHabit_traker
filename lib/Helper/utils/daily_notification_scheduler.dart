...
class DailyNotificationScheduler {
  ...
  static Future<void> scheduleMorningReminder(String userId) async {
    try {
      ...
      final isEnabled =
          await NotificationPreferencesService.isMorningReminderEnabled(
              userId);
      if (!isEnabled) {
      ...
      print('DailyNotificationScheduler: Error scheduling morning reminder: $e');
    }
  }
  ...
  static Future<void> scheduleEveningReminder(String userId) async {
    try {
      ...
      print('DailyNotificationScheduler: Error scheduling evening reminder: $e');
    }
  }
