...
class HabitProgressTrendWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final quantityData = dailyHistory
        .where((day) => day['status'] == 'completed')
        .map((day) {
    ...
    final quantities = quantityData.map((d) => d['quantity'] as double).toList();
    final minValue = 0.0;
    final maxValue = quantities.isEmpty
        ? 1.0
        : quantities.reduce((a, b) => a > b ? a : b);
