...
class InstanceDataBuilder {
  ...
  static Map<String, dynamic> createInstanceData({
    ...
    final instanceData = <String, dynamic>{
      ...
      if (queuePointsOrder != null) 'queuePointsOrder': queuePointsOrder,
      if (queueTimeOrder != null) 'queueTimeOrder': queueTimeOrder,
      if (queueUrgencyOrder != null) 'queueUrgencyOrder': queueUrgencyOrder,
    ...
    return schema.createActivityInstanceRecordData(
      ...
      queuePointsOrder: instanceData['queuePointsOrder'] as int?,
      queueTimeOrder: instanceData['queueTimeOrder'] as int?,
      queueUrgencyOrder: instanceData['queueUrgencyOrder'] as int?,
