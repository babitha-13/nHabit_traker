...
import 'package:habit_tracker/Screens/Shared/Activity_create_edit/Activity%20Editor%20Dialog/Services/activity_editor_helper_service.dart';
import 'package:habit_tracker/Screens/Shared/Activity_create_edit/Activity%20Editor%20Dialog/Services/activity_editor_initialization_service.dart';
import 'package:habit_tracker/Screens/Shared/Activity_create_edit/Activity%20Editor%20Dialog/Services/activity_editor_ui_builders_service.dart';
...
class _ActivityEditorDialogState extends State<ActivityEditorDialog> {
  ...
  set originalFrequencyConfig(FrequencyConfig? value) => _originalFrequencyConfig = value;
  ...
  set defaultTimeEstimateMinutes(int? value) => _defaultTimeEstimateMinutes = value;
