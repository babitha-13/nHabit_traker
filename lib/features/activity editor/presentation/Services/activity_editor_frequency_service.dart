...
class ActivityEditorFrequencyService {
  ...
  static bool hasFrequencyChanged(ActivityEditorDialogState state) {
    ...
    return original.type != current.type ||
        ...
        !ActivityEditorHelperService.listEquals(
            original.selectedDays, current.selectedDays);
  }
  ...
  static Future<void> handleOpenFrequencyConfig(
  ...
  static EssentialFrequencyPayload frequencyPayloadForEssential(
      ActivityEditorDialogState state) {
