  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        drawer:
            ProgressStatsWidgets.buildDrawer(context: context, theme: theme),
        appBar: AppBar(
      ...
      child: Column(
        ...
        children: [
          ProgressStatsWidgets.buildCumulativeScoreCard(
            context: context,
            logic: this,
            onShowBreakdown: (displayGain) =>
                showScoreBreakdownDialog(displayGain),
          ),
          ...
          const SizedBox(height: 16),
          ProgressStatsWidgets.buildAggregateStatsSection(
              context: context, logic: this),
        ],
      ),
    );
  }
