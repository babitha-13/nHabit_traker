...
class CreateEssentialItemDialog extends StatefulWidget {
  final Function(ActivityRecord) onItemCreated;
  const CreateEssentialItemDialog({
    Key? key,
    required this.onItemCreated,
  }) : super(key: key);
  @override
  _CreateEssentialItemDialogState createState() =>
      _CreateEssentialItemDialogState();
}

class _CreateEssentialItemDialogState extends State<CreateEssentialItemDialog> {
  ...
  Future<void> _createEssentialItem() async {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                'Note: This item is essential and will only appear in routines. It tracks time but does not earn points.',
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: _isCreating ? null : _createEssentialItem,
          child: _isCreating
              ? const SizedBox(
                  width: 16,
                  height: 16,
