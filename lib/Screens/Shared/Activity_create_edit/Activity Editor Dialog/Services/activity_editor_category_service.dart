...
class ActivityEditorCategoryService {
  ...
  static Future<void> showCreateCategoryDialog(ActivityEditorDialogState state) async {
    ...
    if (result != null && result is String) {
      ...
      await ActivityEditorInitializationService.loadCategories(state, selectCategoryId: result);
    } else if (result == true) {
