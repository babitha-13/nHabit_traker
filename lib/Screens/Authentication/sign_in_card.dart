...
class SignInCard extends StatefulWidget {
  ...
  const SignInCard({super.key, required this.model, required this.authManager, required this.animationsMap});
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: GradientButton(
                        onPressed: () async {
                          ...
                          final email = widget.model.emailAddressTextController.text.trim();
                          final password = widget.model.passwordTextController.text.trim();
        ...
        ).animateOnPageLoad(widget.animationsMap[
